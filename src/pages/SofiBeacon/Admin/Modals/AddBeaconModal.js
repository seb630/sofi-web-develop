    ...
    handleSave = async () => {
        try {
            ...
            if(selectedUserId) {
                ...
                await actions.sofiBeacon.associateBeaconUser({ userId: selectedUserId, beaconId: beacon.id  })
                await actions.sofiBeacon.fetchBeaconUsers(beacon.pub_id)
